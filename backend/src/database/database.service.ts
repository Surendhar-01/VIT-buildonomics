...
if __name__ == "__main__":
    ...
    // Seed Surendhar S (Current student user)
    const surendharId = 'e393dd34-a2c2-4de6-b954-5b1983d0e304';
    const surendharUser = {
      id: surendharId,
      email: 'surendharkavin01@gmail.com',
      full_name: 'Surendhar S',
      fullName: 'Surendhar S',
      role: 'student',
    };
    this.inMemory.users.set(surendharId, surendharUser);
    this.inMemory.userRoles.set(surendharId, ['student']);
    this.inMemory.profiles.set(surendharId, {
      id: surendharId,
      user_id: surendharId,
      full_name: 'Surendhar S',
      avatar_url: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150',
      headline: 'Full-Stack Engineer',
      bio: 'Full-stack software engineering student specializing in scalable distributed web architectures, cryptography, and verifiable digital credentials.',
      location: 'Vellore, Tamil Nadu, India',
      education: 'B.Tech in Computer Science and Engineering',
      institution: 'Vellore Institute of Technology',
      graduation_year: 2026,
      experience: 'Lead Developer @ Buildonomics Solutions (2025 - Present)',
      github_url: 'https://github.com/Surendhar-01',
      linkedin_url: 'https://linkedin.com/in/surendhar-s',
      resume_url: '',
      visibility: 'public',
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    ...
    this.inMemory.profileSkills.set(surendharId, [
      { id: 'ps-sur-1', profile_id: surendharId, skill_name: 'React.js', skill_id: 'sk-1', proficiency_level: 'expert', evidence_description: 'Engineered responsive single-page applications with state management', verified: true },
      { id: 'ps-sur-2', profile_id: surendharId, skill_name: 'Node.js', skill_id: 'sk-3', proficiency_level: 'advanced', evidence_description: 'Designed high-throughput REST API microservices handling authenticated pipelines', verified: true },
      { id: 'ps-sur-3', profile_id: surendharId, skill_name: 'PostgreSQL', skill_id: 'sk-5', proficiency_level: 'advanced', evidence_description: 'Built relational schemas with ACID compliance and cryptographic audit logging', verified: true },
    ]);

    this.inMemory.projects.set('proj-sur-1', {
      id: 'proj-sur-1',
      profile_id: surendharId,
      title: 'AI SkillProof Platform',
      description: 'Decentralized cryptographic credential verification platform utilizing RFC 8032 Ed25519 digital signatures and automated code assessment sandboxes.',
      technologies: ['React.js', 'NestJS', 'PostgreSQL', 'TailwindCSS', 'Ed25519'],
      repository_url: 'https://github.com/Surendhar-01/VIT-buildonomics',
    ...
    this.inMemory.projects.set('proj-sur-2', {
      id: 'proj-sur-2',
      profile_id: surendharId,
      title: 'Enterprise Talent Pipeline & Discovery Hub',
      description: 'Real-time recruiter pipeline with verified skill badges, candidate shortlisting, and tamper-proof cryptographic audit tracking.',
      technologies: ['TypeScript', 'Node.js', 'Supabase', 'Vite'],
      repository_url: 'https://github.com/Surendhar-01/VIT-buildonomics',
      live_url: 'http://localhost:5173/recruiter',
    ...
    this.inMemory.portfolios.set('port-surendhar', {
      id: 'port-surendhar',
      profile_id: surendharId,
      title: 'Surendhar S — Software Engineer Portfolio',
      slug: 'surendhar-s',
      template: 'modern-minimal',
      theme: 'dark-indigo',
      is_published: true,
